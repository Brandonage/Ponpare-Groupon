...
coupon_list_train <- read.csv("/Users/alvarobrandon/GitHub/AuxFiles/Ponpare Groupon/coupon_list_train_translated.csv")
coupon_list_test <- read.csv("/Users/alvarobrandon/GitHub/AuxFiles/Ponpare Groupon/coupon_list_test.csv")
...
user_list <- read.csv("/Users/alvarobrandon/GitHub/AuxFiles/Ponpare Groupon/user_list.csv")
coupon_detail_train <- read.csv("/Users/alvarobrandon/GitHub/AuxFiles/Ponpare Groupon/coupon_detail_train.csv")
